...
export const handleRegisterUserMail = ({
  ...
  const emailData = {
    ...
    subject: `Complete Your Registration with Expense Manager`,
    html: `
        <p>Hello,</p>
        <p>You're just one step away from creating your account on Expense Manager. Please click the button below to confirm your email address and activate your account:</p>
        ...
        `,
    text: `Hello,\n\nYou're just one step away from creating your account on Expense Manager. Please copy and paste the following link into your browser to confirm your email address and activate your account: ${APP_BASE_URL}/auth/register?token=${token}\n\nThis link will expire in 1 hour. If you did not request an account, please ignore this email or let us know at info@pabloaviles.es.`,
  };
