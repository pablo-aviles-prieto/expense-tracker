...
export const handleResetPasswordMail = ({
  ...
  const emailData = {
    ...
    subject: `Reset Your Password on Expense Manager`,
    html: `
          <p>Hello,</p>
          <p>You have requested to reset your password on Expense Manager. Click the button below to proceed:</p>
          ...
          `,
    text: `You have requested to reset your password on Expense Manager. Please copy and paste the following link into your browser: ${APP_BASE_URL}/auth/recovery?token=${token} This link will expire in 1 hour. If you did not request a password reset, please ignore this email or contact us at info@pabloaviles.es.`,
  };
